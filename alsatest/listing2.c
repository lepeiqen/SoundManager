 ...
 *                      */  
    ...
    {    
        ...
        //rc = snd_pcm_open(&handle, "default", SND_PCM_STREAM_PLAYBACK, 0);// "hw:0,0" ""
        //rc = snd_pcm_open(&handle, "hw:0,0", SND_PCM_STREAM_PLAYBACK, 0);// "hw:0,0" "plughw:0,0"
        rc = snd_pcm_open(&handle, "plughw:0,0", SND_PCM_STREAM_PLAYBACK, 0);// "hw:0,0" "plughw:0,0"
        if (rc < 0) {    
